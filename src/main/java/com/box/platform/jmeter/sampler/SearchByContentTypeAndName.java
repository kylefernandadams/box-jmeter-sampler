...
/**
 *  JMeter sampler client which searches for Box files based on content type and name.
 */
public class SearchByContentTypeAndName implements JavaSamplerClient {
    ...
    public Arguments getDefaultParameters() {
        ...
        defaultParameters.addArgument(CONTENT_TYPES, "${" + CONTENT_TYPES + "}");
    ...
    public void setupTest(JavaSamplerContext setupContext) {
        try {
            ...
            String contentTypeString = setupContext.getParameter(CONTENT_TYPES);
            contentTypeList = Arrays.asList(contentTypeString.split(","));
    ...
    public SampleResult runTest(JavaSamplerContext runContext) {
        ...
        try{
            ...
            boxSearchParameters.setContentTypes(contentTypeList);
