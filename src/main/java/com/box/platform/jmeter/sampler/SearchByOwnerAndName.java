...
/**
 *  JMeter sampler client which searches for Box files based on owner user id and name.
 */
public class SearchByOwnerAndName implements JavaSamplerClient {
    ...
    private static final String OWNER_USER_IDS = "owner.user.ids";
    ...
    private List<String> ownerUserIdList = new ArrayList<String>();
    ...
    public Arguments getDefaultParameters() {
        ...
        defaultParameters.addArgument(OWNER_USER_IDS, "${" + OWNER_USER_IDS + "}");
    ...
    public void setupTest(JavaSamplerContext setupContext) {
        try {
            ...
            String ownerUserIdString = setupContext.getParameter(OWNER_USER_IDS);
            ownerUserIdList = Arrays.asList(ownerUserIdString.split(","));
    ...
    public SampleResult runTest(JavaSamplerContext runContext) {
        ...
        try{
            ...
            boxSearchParameters.setOwnerUserIds(ownerUserIdList);
