...
/**
 *  JMeter sampler client which searches for Box files based on file extension, file name, and metadata.
 */
public class SearchByFileExtensionNameAndMetadata implements JavaSamplerClient {
